...
?>
    ...
    <div class="col-sm-9">
                <div class="container">
                    <h2 class="border border-4 mb-4 text-black-50 p-3 text-center rounded">Cập nhật tài khoản</h2>
                <div class="container text-bg-light rounded">
                    ...
                    <form action="indexadmin.php?act=updatetk" method="post">
                        ...
                        <div class="mb-3 mt-3">
                        <button type="submit" class="btn btn-primary btn-sm" name="update">Cập nhật</button>
                            <button type="reset" class="btn btn-primary btn-sm">Nhập lại</button>
                            <a href="index.php?act=listtk">
                                <button type="button" class="btn btn-primary btn-sm">Danh sách khách hàng</button>
                            </a>
                        </div>
                    </form>
                </div>
